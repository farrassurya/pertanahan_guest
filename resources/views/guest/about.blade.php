        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img">
                        <img class="img-fluid w-100 rounded shadow-sm" src="{{ asset('assets-guest/img/digital_map_placeholder.jpg') }}" alt="Ilustrasi Administrasi Tanah Digital">
                    </div>
                </div>
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p class="mb-4">
                        Halo! Kenalin, kita dari tim <strong>PERTANAHAN</strong>. Mengurus data tanah itu bisa ribet—jadi kami buat solusi digital yang menyederhanakan semua administrasi persil. Tujuan kami jelas: data yang terstruktur, aman, dan gampang diakses.
                    </p>
