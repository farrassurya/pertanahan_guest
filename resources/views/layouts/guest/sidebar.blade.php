...
<aside id="user-sidebar" class="user-sidebar">
    <div class="user-sidebar-inner">
        ...
        <div class="list-group mb-3">
            ...
            @else
                <a href="{{ route('pages.auth.index') }}" class="list-group-item list-group-item-action">Login</a>
                <a href="{{ route('pages.auth.register') }}" class="list-group-item list-group-item-action">Sign Up</a>
                <a href="{{ route('pages.auth.users') }}" class="list-group-item list-group-item-action">User</a>
                <a href="{{ route('pages.jenis-penggunaan.index') }}" class="list-group-item list-group-item-action">DB Jenis Penggunaan</a>
            @endif
        </div>
