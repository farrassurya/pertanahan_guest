        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex pt-3">
                    <a class="btn btn-square btn-light me-2" href="https://wa.me/+628117691328" aria-label="WhatsApp" target="_blank" rel="noopener">
                        <!-- Clean WhatsApp SVG (compact phone in circle) -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" role="img">
                            <path d="M12 2C6.48 2 2 6.48 2 12c0 2.21.7 4.25 1.88 5.93L2 22l4.24-1.22A9.93 9.93 0 0012 22c5.52 0 10-4.48 10-10S17.52 2 12 2zM9.5 8.5c.17.33.47.88.86 1.47.35.52.76 1.04 1.08 1.36.32.32.84.73 1.36 1.08.59.39 1.14.69 1.47.86.37.2.73.12 1-.15.27-.27.35-.63.15-1-.17-.33-.47-.88-.86-1.47-.35-.52-.76-1.04-1.08-1.36-.32-.32-.84-.73-1.36-1.08-.59-.39-1.14-.69-1.47-.86-.37-.2-.73-.12-1 .15-.27.27-.35.63-.15 1z"/>
                        </svg>
                    </a>

                    <a class="btn btn-square btn-light me-2" href="https://www.instagram.com/farrassuryaa?igsh=cnJjY3U2MWdkd2pt" aria-label="Instagram" target="_blank" rel="noopener">
                        <!-- Instagram SVG -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                            ...
                            <path d="M12 7a5 5 0 110 10 5 5 0 010-10zm0 1.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7zM17.8 6.2a1.05 1.05 0 11-2.1 0 1.05 1.05 0 012.1 0z"/>
                        </svg>
                    </a>

                    <a class="btn btn-square btn-light me-2" href="https://youtu.be/CghoDWzy3xo?si=to_RY35EJL57UK8O" aria-label="YouTube" target="_blank" rel="noopener">
                        <!-- YouTube SVG -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                            <path d="M23.5 6.2s-.24-1.7-.98-2.44c-.94-.98-2-1.01-2.49-1.07C16.8 2.5 12 2.5 12 2.5h-.02s-4.8 0-7.99.12c-.5.06-1.55.09-2.49 1.07C.74 4.5.5 6.2.5 6.2S.25 8 .25 9.8v2.4c0 1.8.25 3.6.25 3.6s.24 1.7.98 2.44c.94.98 2.18.95 2.72 1.06 1.97.23 8.3.24 8.3.24s4.8 0 7.99-.12c.5-.06 1.55-.09 2.49-1.07.74-.74.98-2.44.98-2.44s.25-1.8.25-3.6v-2.4c0-1.8-.25-3.6-.25-3.6zM9.75 15.02V8.98L15.75 12l-6 3.02z"/>
                        </svg>
                    </a>
                </div>
            </div>
...
<style>
    ...
    .fab-action.youtube { background: #FF0000; }
...
<div class="fab-container" id="fabContainer" aria-haspopup="true" aria-expanded="false">
    <div class="fab-actions" id="fabActions">
        <a href="https://wa.me/+628117691328" class="fab-action whatsapp" target="_blank" rel="noopener" aria-label="WhatsApp">
            <!-- FAB WhatsApp: simplified icon for small circle -->
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" role="img">
                <path d="M12 2C6.48 2 2 6.48 2 12c0 2.21.7 4.25 1.88 5.93L2 22l4.24-1.22A9.93 9.93 0 0012 22c5.52 0 10-4.48 10-10S17.52 2 12 2zm-1.5 6c.17.33.47.88.86 1.47.35.52.76 1.04 1.08 1.36.32.32.84.73 1.36 1.08.59.39 1.14.69 1.47.86.37.2.73.12 1-.15.27-.27.35-.63.15-1-.17-.33-.47-.88-.86-1.47-.35-.52-.76-1.04-1.08-1.36-.32-.32-.84-.73-1.36-1.08-.59-.39-1.14-.69-1.47-.86-.37-.2-.73-.12-1 .15-.27.27-.35.63-.15 1z"/>
            </svg>
        </a>
