        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0" style="padding:0.6rem 0;">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <a href="{{ route('pages.guest.about') }}" class="nav-item nav-link {{ request()->routeIs('pages.guest.about') ? 'active' : '' }}">About</a>
                    ...
                    @auth
                    <a href="{{ route('pages.auth.users') }}" class="nav-item nav-link {{ request()->routeIs('pages.auth.users') ? 'active' : '' }}">
                        User
                    </a>
                    @endauth
                </div>
